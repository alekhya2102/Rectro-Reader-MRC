...
import sys
sys.path.insert(1, '/Users/ashish/Downloads/AwesomeMRC-master/transformer-mrc/')
from transformers2.data.processors.squad import SquadV1Processor, SquadV2Processor, SquadResult
from transformers2.data.metrics.squad_metrics import compute_predictions_logits, compute_predictions_log_probs, squad_evaluate
...
from transformers2 import (WEIGHTS_NAME, BertConfig,
...
from transformers2 import AdamW, get_linear_schedule_with_warmup, squad_convert_examples_to_features
    ...
    if args.do_eval and args.local_rank in [-1, 0]:
        ...
        if args.do_train:
            ...
            if args.eval_all_checkpoints:
                ...
                logging.getLogger("transformers2.modeling_utils").setLevel(logging.WARN)  # Reduce model loading logs
        else:
            if args.eval_all_checkpoints:
                checkpoints = list(os.path.dirname(c) for c in sorted(glob.glob(args.output_dir + '/**/' + WEIGHTS_NAME, recursive=True)))
